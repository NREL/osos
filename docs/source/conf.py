...
author = 'NREL: Grant Buster'

pkg = os.path.dirname(os.path.abspath(os.path.dirname(__file__)))
pkg = os.path.dirname(pkg)
sys.path.append(pkg)

from osos.version import __version__ as v
...
latex_documents = [
    (master_doc, 'osos.tex', 'osos documentation',
     'Grant Buster', 'manual'),
]
...
man_pages = [
    (master_doc, 'osos', 'osos documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'osos', 'osos documentation',
     author, 'osos', 'One line description of project.',
     'Miscellaneous'),
]
